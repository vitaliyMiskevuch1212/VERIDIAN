...
return events.filter(e => {
  ...
  const filteredVessels = useMemo(() => {
    ...
    return vessels.filter(v => (v.vesselType || '').toLowerCase() === vesselCategory.toLowerCase());
  ...
  const value = useMemo(() => ({
    ...
    activeTab, isCommsActive, handleCommsToggle, leftPanelVisible, setLeftPanelVisible, rightPanelVisible, setRightPanelVisible, flightCategory, wargameEvent, isOmniOpen, isShortcutsOpen,
